namespace AnteyaVIP.Data.Repositories.Base
{
    using System;
    ...
    using AnteyaVIP.Common.Extensions;
    ...
    public class GenericRepository<T> : IRepository<T> where T : class
    {
        ...
        /// </summary>
        /// <param name="entity">Expression for the updated entity</param>DigitalLibraryDbContext
